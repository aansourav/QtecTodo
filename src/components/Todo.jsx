...
const Todo = () => {
  return (
    <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
      ...
      <div className="select-none flex-1 line-through">Making Todo App for Qtec</div>
      ...
      <img src={cancelIcon} className="flex-shrink-0 w-4 h-4 ml-2 cursor-pointer" alt="Cancel" />
    </div>
  );
};
